    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Title2.default, { title: 'WebPack plugins', noumber: this.state.data.length }),
                _react2.default.createElement(_TodoList2.default, { items: this.state.data, remove: function remove(id) {
...
var TodoList = function TodoList(props) {
    var doing = props.items.map(function (item) {
